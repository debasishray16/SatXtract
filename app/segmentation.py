...
MODELS = {
    "resnet50": {
        ...
        "file_name": "landcover_resnet50_50_epochs_batch16.hdf5",
        "backbone": "resnet50",
    },
    "resnet101": {
        "description": "Unet ResNet-101",
        "file_name": "landcover_resnet101_50_epochs_batch16.hdf5",
        "backbone": "resnet101",
    },
}
...
def main():
    ...
    tab1, tab2, tab3, tab4 = st.tabs(
        ["Live segmentation", "From file", "Examples"]
    )
