...
file_path = "C:/Users/debas/UHI_Prediction/Urban-Heat-Island/app/data/models/landcover_resnet50_100_epochs_batch16_freeze.hdf5"

if os.path.exists(file_path):
    print("✅ File found, proceeding with upload...")
    
    api.upload_file(
        path_in_repo="landcover_resnet50_100_epochs_batch16_freeze.hdf5",
